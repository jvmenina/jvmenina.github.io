    ...
    <footer className={styles['site-footer']}>
      <div className={[
        ...
        <div className={styles['site-footer__credits']}>
          ...
          <p>
            The design of this website, its logo, and my personal photo are provided by myself and can be seen <a href="https://github.com/jmichaelmenina/web-jmichael" target="_blank" rel="noreferrer">here</a>. This website is not monetized by myself in any way.
          </p>
        </div>
      </div>
    </footer>
